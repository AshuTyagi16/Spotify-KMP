...
import com.spotify.app.feature_homepage.shared.di.getHomePageDriverModule

fun getSharedModules() =
    loggerModule + preferencesModule + networkModule + featureHomePageModule + getHomePageDriverModule()
