...
fun getSharedModules() =
    loggerModule + preferencesModule + networkModule + featureHomePageModule + getHomePlatformModule() + featurePlaylistDetailModule + getFeaturePlaylistDetailPlatformModule()
